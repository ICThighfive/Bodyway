...
//		}
		...
		// 페이지별로 출력되는 운동일지 목록 조회 처리용 컨트롤러
		...
		// 한 페이지에 출력할 목록이 10개면, 3 페이지
		int maxPage = (int) ((double) listCount / limit + 0.9);

		// 뷰에 출력할 페이지그룹의 시작 페이지 지정
		// 뷰 목록 아래쪽에 페이지 숫자를 10을 출력한다면..
		// 현재 페이지가 3페이지면, 페이지 그룹은 1 ~ 10 이 됨
		// 현재 페이지가 15페이지면, 페이지 그룹은 11 ~ 20 이 됨
